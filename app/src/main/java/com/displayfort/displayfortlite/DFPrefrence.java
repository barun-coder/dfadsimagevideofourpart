...
public class DFPrefrence {
    ...
    private static final String SHARED_PREFERENCE_NAME = "DFLiteSharedPreference";
    private static final String SHARED_PREFERENCE_NAME_TUTORIAL = "DFLiteSharedPreferenceTUORIAL";
