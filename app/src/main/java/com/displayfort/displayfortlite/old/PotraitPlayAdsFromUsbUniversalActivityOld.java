 ...
 * MyApplication
 */
public class PotraitPlayAdsFromUsbUniversalActivityOld extends BaseSupportActivity implements SurfaceHolder.Callback {
    ...
    private void check() {
        try {
            ...
            for (File inFile : files) {
                Toast.makeText(PotraitPlayAdsFromUsbUniversalActivityOld.this, "" + inFile.getAbsolutePath(), Toast.LENGTH_SHORT).show();
